...
const SilverNecklaces = () => {
  const { addToCart, toggleWishlist, wishlist } = useCart();
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const products = [
    { id: 'sn-1', name: "Silver Curb Chain", price: 12000, image: "/images/silver-curb-chain.jpg", category: "Silver" },
    { id: 'sn-2', name: "Delicate Silver Choker", price: 8500, image: "/images/silver-choker.jpg", category: "Silver" },
  ];
    ...
    <div className="info-page-wrapper">
      <div className="info-container">
        <header className="info-header text-center pt-20">
          <h1 className="serif italic text-4xl mb-4">Silver Necklaces</h1>
          <p className="text-[11px] tracking-[4px] uppercase text-gray-900 font-bold">Refined silver chains and statement neckwear</p>
        </header>
...
export default SilverNecklaces;