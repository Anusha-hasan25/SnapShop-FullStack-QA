...
const MenRings = () => {
  ...
  const products = [
    { id: 'mr-1', name: "Onyx Signet Ring", price: 18500, image: "/images/men-onyx-ring.jpg", category: "Men" },
    { id: 'mr-2', name: "Classic Wedding Band", price: 45000, image: "/images/men-wedding-band.jpg", category: "Men" },
  ];
    ...
    <div className="info-page-wrapper">
      <div className="info-container">
        <header className="info-header text-center pt-20">
          <h1 className="serif italic text-4xl mb-4">Men's Rings</h1>
          <p className="text-[11px] tracking-[4px] uppercase text-gray-900 font-bold">Classic signets and modern bands for him</p>
        </header>
