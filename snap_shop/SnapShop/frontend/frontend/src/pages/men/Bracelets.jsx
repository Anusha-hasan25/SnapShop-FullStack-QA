...
const MenBracelets = () => {
  const { addToCart, toggleWishlist, wishlist } = useCart(); // wishlist context added
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const products = [
    { id: 'mb-1', name: "Cuban Link Wristlet", price: 25000, image: "/images/men-cuban-wristlet.jpg", category: "Men" },
    { id: 'mb-2', name: "Braided Leather Band", price: 8500, image: "/images/men-leather-bracelet.jpg", category: "Men" },
    { id: 'mb-3', name: "Matte Steel Cuff", price: 15000, image: "/images/men-steel-cuff.jpg", category: "Men" },
  ];
    ...
    <div className="info-page-wrapper">
      <div className="info-container">
        <header className="info-header text-center pt-20">
          <h1 className="serif italic text-4xl mb-4">Men's Bracelets</h1>
        ...
        <div className="product-grid mt-16">
          {products.map((item) => {
            const isFavorite = wishlist.some(fav => fav.id === item.id); // Check logic
            return (
              <div key={item.id} className="product-card no-underline text-black group">
                ...
                <div className="text-center pt-6 px-2">
                  <h3 className="serif text-[12px] font-bold tracking-widest uppercase mb-2">{item.name}</h3>
