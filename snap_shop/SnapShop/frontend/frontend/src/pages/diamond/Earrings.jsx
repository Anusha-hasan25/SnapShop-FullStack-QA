...
const DiamondEarrings = () => {
  ...
  const products = [
    { id: 'de-1', name: "Classic Diamond Studs", price: 95000, image: "/images/diamond-studs.jpg", category: "Diamond" },
    { id: 'de-2', name: "Diamond Hoop Earrings", price: 210000, image: "/images/diamond-drop-earrings.jpg", category: "Diamond" },
  ];
    ...
    <div className="info-page-wrapper">
      <div className="info-container">
        <header className="info-header text-center pt-20">
          <h1 className="serif italic text-4xl mb-4">Diamond Earrings</h1>
          <p className="text-[11px] tracking-[4px] uppercase text-gray-900 font-bold">Brilliant studs and drops designed to shine</p>
        </header>
        <div className="product-grid mt-16">
          {products.map((item) => {
            const isFavorite = wishlist.some(fav => fav.id === item.id); // Logic
            return (
