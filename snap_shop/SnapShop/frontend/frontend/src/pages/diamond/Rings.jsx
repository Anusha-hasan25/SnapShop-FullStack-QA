...
const DiamondRings = () => {
  ...
  const products = [
    { id: 'dr-1', name: "Solitaire Engagement Ring", price: 450000, image: "/images/diamond-solitaire-ring.jpg", category: "Diamond" },
    { id: 'dr-2', name: "Infinity Diamond Band", price: 180000, image: "/images/diamond-infinity-band.jpg", category: "Diamond" },
  ];
    ...
    <div className="info-page-wrapper">
      <div className="info-container">
        <header className="info-header text-center pt-20">
          <h1 className="serif italic text-4xl mb-4">Diamond Rings</h1>
          <p className="text-[11px] tracking-[4px] uppercase text-gray-900 font-bold">A promise of forever in pure brilliance</p>
        </header>
