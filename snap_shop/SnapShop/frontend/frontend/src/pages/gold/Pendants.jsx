...
import "../Collection.css";const GoldPendants = () => {
  const { addToCart, toggleWishlist, wishlist } = useCart();
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const products = [
    { id: 'gp-1', name: "Heart Gold Pendant", price: 35000, image: "/images/gold-heart-pendant.jpg", category: "Gold" },
    { id: 'gp-2', name: "Floral Gold Charm", price: 28000, image: "/images/gold-floral-charm.jpg", category: "Gold" },
  ];
    ...
    <div className="info-page-wrapper">
      <div className="info-container">
        <header className="info-header text-center">
          <h1 className="serif italic">Gold Pendants</h1>
          <p className="text-[11px] tracking-[4px] uppercase text-gray-900 font-bold">Sophisticated 18K designs for everyday elegance</p>
        </header>
