 ...
 * @returns {JSX.Element} The Privacy Policy page JSX.
 */
function Privacy() {
  return (
    <>
      ...
      <div className="page-container page-content">
        ...
        <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from SnapShop  💎 (the “Site”).</p>
        ...
        <h3>CONTACT US</h3>
        <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at support@snapshop.com or by mail using the details provided below:</p>
        <p>SnapShop 💎<br />[Re: Privacy Compliance Officer]<br />123 Main Street, Karachi, Pakistan</p>
      </div>
